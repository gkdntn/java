...
public class Main09 {
	public static void main(String[] args) {
		...
		System.out.println("-------------------------------");
		System.out.println("| "+article1.getNo()+" |   "+article1.getTitle()+"  "
				+ "| "+article1.getContent()+" | "+article1.getUser().getName()+" |");
		System.out.println("-------------------------------");
		System.out.println("ㄴ " + comment1.getContent());
		System.out.println("ㄴ " + comment3.getContent());
		System.out.println("-------------------------------");
		System.out.println("| "+article2.getNo()+" |   "+article2.getTitle()+"  "
				+ "| "+article2.getContent()+" | "+article2.getUser().getName()+" |");
		System.out.println("-------------------------------");
		System.out.println("ㄴ " + comment2.getContent());
		System.out.println("-------------------------------");
		System.out.println("| "+article3.getNo()+" |   "+article3.getTitle()+"  "
				+ "| "+article3.getContent()+" | "+article3.getUser().getName()+" |");
		System.out.println("-------------------------------");
		System.out.println("ㄴ " + comment4.getContent());
		System.out.println("-------------------------------");
	}
}
